...
const HomePage = () => {
	...
	useEffect(() => {
		...
		animate(home, { flexGrow: 1 }, { duration: 0.5 });
	...
	const pageTW = "border md:my-20 bg-pink-500 md:w-20";

	return (
		<section
			className='flex flex-col md:flex-row border border-red-500 md:h-screen'
			ref={scope}
		>
			{/* --------- HOME --------- */}
			...
			<div className='absolute bottom-0 left-0 bg-slate-600 rounded-tr-2xl p-1 px-2 hidden md:block'>
				Navigate by clicking or using{" "}
				<TbArrowBigLeftFilled className='inline' />{" "}
				<TbArrowBigRightFilled className='inline' /> keys
			</div>
			<div className='fixed bottom-0 right-0 bg-slate-600 rounded-tl-2xl p-1 px-2'>
